...
class Disposable_Tech extends Model
{
  ...
  public function maintenance()
  {
    ...
    if(filled($this->duration_a)) { $maintenance->put('duration_a', $this->duration_a); }
    ...
    if(filled($this->duration_b)) { $maintenance->put('duration_b', $this->duration_b); }
    ...
    if(filled($this->duration_c)) { $maintenance->put('duration_c', $this->duration_c); }
