 ...
 */
class EarlyAdopter extends Award
{
    /**
     ...
     * @var string
     */
    public $param_description = 'The number of new users which get this award';
     ...
     *
     * @param int|null $number_of_user The parameters passed in from the UI
     *
     * @return bool
     */
    public function check($number_of_user = null): bool
    {
        if (!$number_of_user) {
            $number_of_user = 25;
        }

        return $this->user->id <= $number_of_user;
    }
}
