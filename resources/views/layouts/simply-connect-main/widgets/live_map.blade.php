...
--}}
<div id="live_flights" class="p-4 row">
  <div class="col-md-12">
    <div rv-hide="has_data" class="jumbotron m-0 text-center">@lang('widgets.livemap.noflights')</div>
    <table rv-show="has_data" id="live_flights_table" class="table table-striped">
      ...
      <tr class="text-small header">
        ...
        <td class="text-small">Captain</td>
